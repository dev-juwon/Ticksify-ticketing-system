...
>
    <nav class="space-y-1">
        ...
        >
            ...
            <a
                role="button"
                class="border-transparent text-slate-900 hover:bg-slate-50 hover:text-slate-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium"
                onclick="event.preventDefault(); this.closest('form').submit();"
            >
                <x-heroicon-o-arrow-right-circle class="text-slate-400 group-hover:text-slate-500 flex-shrink-0 -ml-1 mr-3 h-6 w-6" />
                <span class="truncate">{{ __('Sign out') }}</span>
            </a>
        </form>
    </nav>
</aside>
