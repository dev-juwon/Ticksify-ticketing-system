...
class TicketCreator extends Component
{
    ...
    public function verifyEnvatoPurchaseCode(): bool
    {
    ...
    {
        $this->validate();
        if ($this->selectedProduct->provider === ProductProvider::ENVATO->name && $this->envatoSettings->token_enabled && ! $this->verifyEnvatoPurchaseCode()) return;
    ...
    {
        return Product::with('media')->whereNull('disabled_at')->get();
    }
